...
archetype** — the design partner entity fabric (their in-house fabric).
...
- the design partner entity fabric: "an entity-fabric vendor white paper —
  title withheld" (vendor white
  paper, ©2024; received from the prospect 2026-08-09, on file — public
  copies via link-removed). Reviewed
