...
| P1.6 golden gate | ✅ contracts encoded (reconciliation / anchor / citations-empty / partial-failure); 5 live cases green (g1–g5, incl. the three-source g5). **Remaining:** the six locked prompts once P1.3-full lands |
