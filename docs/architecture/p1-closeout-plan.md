...
| P1.6 golden gate | ✅ contracts encoded (reconciliation / anchor / citations-empty / partial-failure); 7 live cases green (g1–g7, incl. the three-source g5 and the native-ClickHouse FILTER/OPTIONAL g7). **Remaining:** the six locked prompts once P1.3-full lands |
